...
const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-gradient-to-r from-white via-green-200/60 to-white flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 mt-40 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500  ">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <a href="/" className="hover:text-green-800 transition">
                  Careers
                  <span className="text-xs text-white bg-green-800 rounded-md ml-2 px-2 py-1">
                    We’re hiring!
                  </span>
                </a>
              </li>
