  ...
  return (
    <div id="features" className=" flex flex-col items-center my-10">
      ...
      <Title
        ...
        description="Our streamlined process  helps you create  a professional resume in  minutes with intelligent AL-powered tools and features.   "
      />

      <div className="flex xl:-mt-10 flex-col md:flex-row items-center justify-center">
        <img
        ...
        >
          ...
          >
            <div
              className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transi tion-colors ${
